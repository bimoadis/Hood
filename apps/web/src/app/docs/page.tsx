      ...
      <main className="min-w-0 pb-24">
        <div className="mb-14">
          ...
          <h1 className="font-display font-bold text-4xl lg:text-5xl mt-3 leading-tight text-black">
            Your pixel companion,<br />running on Robinhood Chain.
          </h1>
        ...
        <section id="about" className="py-10 border-t border-black/10 scroll-mt-[90px]">
          ...
          <p className="text-black/70 max-w-2xl mb-4">
            <strong>Hoodfolk</strong> is a platform on Robinhood Chain launched on pump.fun for raising AI-driven digital companions directly through 𝕏 (Twitter) — a living Pixel Art creature that grows, develops personality, and forms bonds with other companions across the network, entirely through ordinary conversation.
          </p>
